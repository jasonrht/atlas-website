        ...
        return (
            <>
                ...
                <div className='w-11/12'>
                    ...
                    <table className='bg-slate-100 border-6 border-black rounded-t-md mb-3'>
                        <thead>
                            <tr className='bg-blue-1000 border-2 border-black'>{columns}</tr>
                        </thead>
                        <tbody>
                            {rowsSP}
                        </tbody>
                    ...
                    <h1>Promotors</h1>
                    <table className='bg-slate-100 border-2 border-black rounded-t-md overflow-hidden mb-3'>
                        <thead>
